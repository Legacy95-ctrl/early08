...
define('PAGE_TITLE', 'ROBLOX - Badges');
require __DIR__ . '/includes/header.php';
?>
    <div id="BadgesContainer">
        <div id="BadgesAndRankings">
            <div>
                <h4 class="TopAccordionHeader" id="combheader" onclick="openAccordian('comb');">Community Badges</h4>
            </div><div id="comb" style="display:block;">
                <div id="CommunityBadges">
                    <div class="Legend">
                        <ul class="BadgesList">
                            ...
                            <li id="ForumModerator">
                                ...
                                <div>Users with this badge are forum moderators. They have special powers on the ROBLOX forum and are able to delete threads that violate the Community Guidelines. Users who are exemplary citizens on ROBLOX over a long period of time may be invited to be moderators. This badge is granted by invitation only.</div>
                            </li>
                            <li id="ImageModerator">
                                <h4>Image Moderator Badge</h4>
                                <div>Users with this badge are image moderators. Image moderators have special powers on ROBLOX that allow them to approve or disapprove images that other users upload. Rejected images are immediately banished from the site. Users who are exemplary citizens on ROBLOX over a long period of time may be invited to be moderators. This badge is granted by invitation only.</div>
                            </li>
                        </ul>
                    </div>
                    <div id="FeaturedBadge_Community">
                        ...
                        <div class="FeaturedBadgeContent">
                            <div class="FeaturedBadgeIcon"><img src="resources/Badges/BuildersClub-125x125.png" height="125" width="125" border="0" alt="Builders Club" /></div>
            ...
            <div>
                <h4 class="AccordionHeader" id="bilbheader" onclick="openAccordian('bilb');">Builder Badges</h4>
            </div><div id="bilb" style="display:none;">
                <div id="VisitsBadges">
                    <div class="Legend">
                        <ul class="BadgesList">
                            <li id="Homestead">
            ...
            <div>
                <h4 class="AccordionHeader" id="fribheader" onclick="openAccordian('frib');">Friendship Badges</h4>
            </div><div id="frib" style="display:none;">
            ...
            <div>
                <h4 class="BottomAccordionHeader" id="conbheader" onclick="openAccordian('conb');">Combat Badges</h4>
            </div><div id="conb" style="display:none;">
                <div id="CombatBadges">
                    <div class="Legend">
                        <ul class="BadgesList">
                            ...
                            <li id="Warrior">
                                <h4>Warrior Badge</h4>
                                <div>This badge is given to the warriors of ROBLOX, who have time and time again overwhelmed their foes in battle. To earn this badge, you must rack up 100 knockouts. Anyone with this badge knows what to do in a fight!</div>
                            </li>
                            <li id="Bloxxer">
                                <h4>Bloxxer Badge</h4>
...
<script>
function openAccordian(header) {
    var ids = ['comb', 'bilb', 'frib', 'conb'];
    for (var i = 0; i < ids.length; i++) {
        document.getElementById(ids[i]).style.display = (ids[i] === header) ? 'block' : 'none';
    }
}
</script>
